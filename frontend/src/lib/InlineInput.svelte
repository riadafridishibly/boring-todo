...
<div class="flex items-center">
  <a href="/" class="block flex-none px-4" use:link>
    <div class="flex items-center">
      <svg
  ...
  <form class="relative flex-grow" on:submit|preventDefault={handleSubmit}>
    ...
    <div
      class="absolute pointer-events-none right-0 top-1/2 transform -translate-x-1/2 -translate-y-1/2"
    >
      <svg
        class="w-6 h-6 stroke-gray-500 stroke-1 "
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
        xmlns="http://www.w3.org/2000/svg"
  ...
  <button type="button" on:click={openModal} class="flex-none px-4">
    <div class="flex items-center">
      <svg
        ...
        /></svg
      >
      <!-- <span class="text-2xl font-light px-1">Delete</span> -->
    </div>
  </button>
</div>
